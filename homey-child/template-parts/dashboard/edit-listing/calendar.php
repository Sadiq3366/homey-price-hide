...
<div id="calendar-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
        <div class="calendar-navigation custom-actions">
            ...
            <a class="btn btn-secondary-outlined btn-reserve-period" data-toggle="modal" data-target="#modal-scrap-dates"><?php echo esc_html__('Scrap Dates', 'homey'); ?></a>
...
<?php get_template_part('template-parts/dashboard/sultan-ical-import'); ?>
