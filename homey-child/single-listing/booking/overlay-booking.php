		...
		<div class="block">
			<div class="sidebar-booking-module-body">
				<div class="homey_notification search-wrap search-banner">
					...
					<button data-whats-app-message-body="<?php echo homey_option('homey_sa_whatsapp_message'); ?>" data-listing-title="<?php echo the_title();?>" data-listing-link="<?php echo get_permalink();?>" data-wa-number="<?php echo homey_option('homey_sa_whatsapp_number'); ?>" id="request_for_reservation_mobile_wa" type="button" class="btn btn-full-width btn-primary"><?php echo esc_html__(homey_option('homey_sa_whatsapp_btn'), 'homey'); ?></button>
