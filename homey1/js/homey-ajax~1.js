...
console.log(messageBody);
            ...
            if(check_in_date == '' || check_out_date == ''){
                notify.prepend('<div class="notify text-danger text-center btn-danger-outlined btn btn-full-width">Please select check in and check out dates.</div>');
                return false;
            }

            if(guests == ''){
                notify.prepend('<div class="notify text-danger text-center btn-danger-outlined btn btn-full-width">Please enter guest number.</div>');
                return false;
            }
