                    ...
                    if ($layout_order) {
                        foreach ($layout_order as $key => $value) {
                            ...
                            switch ($key) {
                                case 'location':
                    ?>
                                    <div class="<?php echo esc_attr($location_classes); ?> sa-map-custom-search-field">
                                        <?php if ($location_field == 'geo_location') { ?>
                                            <label class="animated-label"><?php echo $srh_whr_to_go; ?></label>
                                            <input type="text" name="location_search" autocomplete="off" id="location_search" value="<?php echo esc_attr($location_search); ?>" class="form-control input-search" placeholder="<?php echo $srh_whr_to_go; ?>">
                                        ...
                                        <?php } elseif ($location_field == 'keyword') { ?>
                                            ...
                                            <label class="animated-label"><?php echo $srh_whr_to_go; ?></label>
                                            <input type="text" name="keyword" autocomplete="off" value="<?php echo isset($_GET['keyword']) ? esc_attr($_GET['keyword']) : ''; ?>" class="form-control input-search" placeholder="<?php echo $srh_whr_to_go; ?>">

                                        <?php } elseif ($location_field == 'country' && 1 == 2) { ?>

                                            <select name="country" class="selectpicker" data-live-search="true">
                                                <?php
                                                // All Option
                                                echo '<option id="new_search_text" value="">' . $srh_whr_to_go . '</option>';
                                        ...
                                        <?php } elseif ($location_field == 'country') { ?>
                                            ...
                                            <select name="country" id="sa_country_selectpicker" class="selectpicker" data-live-search="false">
                                                <?php
                                                // All Option
                                                echo '<option id="new_search_text" value="">' . esc_html__('Choose a Country', 'homey') . '</option>';
                                    ...
                                    <?php  $srh_whr_to_go = isset($_REQUEST['city']) && !empty(trim($_REQUEST['city'])) ? $_REQUEST['city'] : $srh_whr_to_go; ?>
                                        <select data-pre-selected-cities-text="<?php echo $srh_whr_to_go; ?>" title="<?php echo esc_html__('City', 'homey'); ?>" name="city" id="sa_city_selectpicker" class="selectpicker" data-live-search="false" multiple="true" data-all-option-is-selected="false">
                                            <?php
                                            // All Option
                                    ...
                                    <?php } elseif ($location_field == 'city') { ?>
                                        ...
                                        <select name="city" class="selectpicker" data-live-search="true" multiple="true" data-all-option-is-selected="false">
                                            <?php
                                            // All Option
                                            echo '<option value="' . $keyword . '">' . $srh_whr_to_go . '</option>';
        ...
        <div class="search-wrap search-banner-mobile">
            <form class="clearfix">
                <div class="search-destination">
                    <?php 
                        if(isset($srh_whr_to_go) && !empty($srh_whr_to_go))
                        {
                		    $city = get_term_by( 'slug', $srh_whr_to_go, 'listing_city' );
                        }
                     ?>
                    <input value="<?php echo esc_attr($location_search); ?>" type="text" class="form-control" placeholder="<?php echo isset($city->name) ? $city->name : ""; ?>" onfocus="blur();">
                </div>
            </form>
        </div> <!-- search-wrap -->
    </div>
