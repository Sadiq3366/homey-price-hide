                ...
                <div class="half-map-search-inner-wrap">
                    ...
                    ?>
                                    ...
                                    <?php  $srh_whr_to_go = isset($_REQUEST['city']) && !empty(trim($_REQUEST['city'])) ? $_REQUEST['city'] : $srh_whr_to_go; ?>
                                        <select data-pre-selected-cities-text="<?php echo $srh_whr_to_go; ?>" title="<?php echo $srh_whr_to_go; ?>" name="city" id="sa_city_selectpicker" class="selectpicker" data-live-search="false" multiple="true" data-all-option-is-selected="false">
                                            <?php
                                            // All Option
