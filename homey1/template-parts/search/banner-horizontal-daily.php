...
<div class="search-wrap search-banner search-banner-desktop hidden-xs">
    <form id="sa_search_form" class="clearfix" action="<?php echo homey_get_search_result_page(); ?>" method="GET">
        ...
        if ($layout_order) {
            foreach ($layout_order as $key => $value) {
                ...
                switch ($key) {
                    case 'location':
        ?>
                        <div class="<?php echo esc_attr($location_classes) . ' ' . esc_attr($radius_class); ?> sa-custom-search-field">
                            ...
                            <?php } elseif ($location_field == 'country') { ?>
                                ...
                                <select name="country" class="selectpicker" data-live-search="false">
                                    <?php
                                    // All Option
                                    echo '<option value="' . $keyword . '">' . esc_html__('Choose a Country', 'homey') . '</option>';
                        ...
                        <?php } elseif ($location_field == 'city') { ?>
                            ...
                            <select name="city" id="myselectpicker" class="selectpicker" data-live-search="true" multiple="true" data-all-option-is-selected="false">
                                <?php
                                // All Option
                                echo '<option value="' . $keyword . '">' . $srh_whr_to_go . '</option>';
        ...
        <div class="search-button">
            <button id="sa_search_form_btn" type="submit" class="btn btn-primary"><?php echo esc_attr($homey_local['search_btn']); ?></button>
        </div>
    </form>
</div><!-- search-wrap -->
