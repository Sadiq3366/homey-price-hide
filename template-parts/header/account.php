        ...
        <ul>
            ...
            if(!homey_is_renter()) {
                ...
                if( !empty($dashboard_experiences) ) {
                    echo '<li><a href="'.esc_url($dashboard_experiences).'"><i class="fa fa-th-list"></i>'.esc_html__('Experiences', 'homey').'</a></li>';
                }

                if( !empty($dashboard_add_experience) ) {
                    echo '<li><a href="'.esc_url($dashboard_add_experience).'"><i class="fa fa-plus-circle"></i>'.esc_html__('Add New Experience', 'homey').' </a></li>';
                }
            ...
            if( !empty($dashboard_exp_reservations) ) {
                $new_notification = homey_booking_notification(1);
                $new_notification = $new_notification > 0 ? '<span class="new-booking-alert" style="display: block;"></span>' : '<span class="new-booking-alert" style="display: none;"></span>';
                echo '<li><a href="'.esc_url($dashboard_exp_reservations).'"><i class="fa fa-calendar"></i>'.esc_html__('Experiences Bookings', 'homey').' '.$new_notification.'</a></li>';
            }

            if( !empty($dashboard_exp_host_reservations) && !homey_is_renter()) {
                echo '<li><a href="'.esc_url($dashboard_exp_host_reservations).'"><i class="fa fa-calendar"></i>'.esc_html__('Experiences Reservations', 'homey').'</a></li>';
            }
