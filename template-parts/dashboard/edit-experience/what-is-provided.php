        ...
        <div style="<?php echo $what_to_provided_hideShow; ?>" class="what_is_provided">
            ...
            if(!empty($what_to_provided)) {
                foreach($what_to_provided as $item_provide):
                    $item_provide_name = isset($item_provide['name']) ? $item_provide['name'] : '';
                    $item_provide_desc = isset($item_provide['desc']) ? $item_provide['desc'] : '';
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $item_provide_name; ?>" id="what_to_bring_name<?php echo $count; ?>" type="text" name="what_to_provided[<?php echo $count; ?>][name]" class="form-control" placeholder="<?php echo esc_html__(esc_attr(homey_option('experience_ad_acc_what_provide_name_plac')), 'homey');?>" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo esc_html__("Description", "homey"); ?></label>
                                    <textarea name="what_to_provided[<?php echo $count; ?>][desc]" class="form-control" rows="3" placeholder="<?php echo esc_html__("Type description here.", "homey"); ?>"><?php echo $item_provide_desc; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="what_to_bring_name<?php echo $count+1; ?>" type="text" name="what_to_provided[<?php echo $count+1; ?>][name]" class="form-control" placeholder="<?php echo esc_html__(esc_attr(homey_option('experience_ad_acc_what_provide_name_plac')), 'homey');?>" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label><?php echo esc_html__("Description", "homey"); ?></label>
                            <textarea name="what_to_provided[<?php echo $count+1; ?>][desc]" class="form-control" rows="3" placeholder="<?php echo esc_html__("Type description here.", "homey"); ?>"></textarea>
                        </div>
                    </div>
                </div>
                <!--<div class="row">
        ...
        <div style="<?php echo $what_to_bring_hideShow; ?>" class="what_to_bring">
            ...
            if(!empty($what_to_bring)) {
                foreach($what_to_bring as $item_bring):
                    ...
                    $item_bring_name = isset($item_bring['name']) ? $item_bring['name'] : '';
                    $item_bring_desc = isset($item_bring['desc']) ? $item_bring['desc'] : '';
                    ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="what_to_bring_name<?php echo $count; ?>" type="text" name="what_to_bring[<?php echo $count; ?>][name]" class="form-control" placeholder="<?php echo esc_html__(esc_attr(homey_option('experience_what_bring_name_plac')), 'homey');?>" ><?php echo $item_bring_name; ?></textarea>
                                </div>
                            </div>
                            <!--<div class="col-sm-12">
                                <div class="form-group">
                                    <label for="what_to_bring<?php //echo $count; ?>desc"><?php //echo esc_html__("Description", "homey"); ?></label>
                                    <textarea id="what_to_bring<?php //echo $count; ?>desc" name="what_to_bring[<?php //echo $count; ?>][desc]" class="form-control" rows="3" placeholder="<?php //echo esc_html__("Type description here", "homey"); ?>"><?php //echo $item_bring_desc; ?></textarea>
                                </div>
                            </div>-->
                        </div>
                        <div class="row">
        ...
        <div class="block-body">
            <div class="more_what_to_bring_main" id="more_what_to_bring_main">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="what_to_bring_name<?php echo $count+1; ?>"><?php echo esc_html__(esc_attr(homey_option('experience_what_bring_name')), 'homey'); //. homey_req('experience_what_brings'); ?> </label>
                            <textarea id="what_to_bring_name<?php echo $count+1; ?>" type="text" name="what_to_bring[<?php echo $count+1; ?>][name]" class="form-control" placeholder="<?php echo esc_html__(esc_attr(homey_option('experience_what_bring_name_plac')), 'homey');?>" ></textarea>
                        </div>
                    </div>
                    <!--<div class="col-sm-12">
                        <div class="form-group">
                            <label for="what_to_bring<?php echo $count+1; ?>desc"><?php echo esc_html__("Description", "homey"); ?></label>
                            <textarea id="what_to_bring<?php echo $count+1; ?>desc" name="what_to_bring[<?php echo $count+1; ?>][desc]" class="form-control" rows="3" placeholder="<?php echo esc_html__("Type description here.", "homey"); ?>"></textarea>
                        </div>
                    </div>-->
                </div>
               <!-- <div class="row">
