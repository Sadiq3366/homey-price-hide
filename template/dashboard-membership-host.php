...
$date = new DateTime($subscription_info['subscriptionExpiryDate']);
$now = new DateTime();
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="wallet-box">
                                            ...
                                            <div class="wallet-box-info mb-0" style="<?php echo $date < $now ? 'color: red;' : '' ?>"><?php echo esc_html__('Your membership will expire on', 'homey').' '.$expiry_date_text; ?></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="wallet-box">
