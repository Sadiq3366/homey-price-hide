...
$weekends_price = homey_get_experience_data('weekends_price');
$weekends_days = homey_get_experience_data('weekends_days');
$priceWeekly = homey_get_experience_data('priceWeek');
$priceMonthly = homey_get_experience_data('priceMonthly');
$min_stay_days = homey_get_experience_data('min_book_days');
$max_stay_days = homey_get_experience_data('max_book_days');
...
if($booking_type == "per_day_date"){
    ...
    $min_stay_value = homey_get_experience_data('min_book_day_dates');
    $max_stay_value = homey_get_experience_data('max_book_day_dates');
    ...
    $min_stay_value = homey_get_experience_data('min_book_days');
    $max_stay_value = homey_get_experience_data('max_book_days');
    ...
    $min_stay_value = homey_get_experience_data('min_book_hours');
    $max_stay_value = homey_get_experience_data('max_book_hours');
    ...
    $min_stay_value = homey_get_experience_data('min_book_weeks');
    $max_stay_value = homey_get_experience_data('max_book_weeks');
    ...
    $min_stay_value = homey_get_experience_data('min_book_months');
    $max_stay_value = homey_get_experience_data('max_book_months');
}
