                ...
                <div class="block-right">
                    <div class="block-col block-col-100 block-accomodation">
                        <dl class="detail-list">
                            ...
                            ?>
                            <dd><i class="fa fa-angle-right" aria-hidden="true"></i> <?php echo esc_html__($item_provide_name, 'homey'); ?> <!--<p><?php echo esc_html__($item_provide_desc, 'homey'); ?></p>--></dd>
                                <?php  $count++;
                            endforeach;
                            } ?>
                        </dl>
                        ...
                        <dl class="detail-list">
                            ...
                            if(!empty($what_to_bring)) {
                                foreach($what_to_bring as $item_bring):
                                    ...
                                    //                    dd($item_provide_desc, 0);
                                    ?>
                                    <dd><i class="fa fa-angle-right" aria-hidden="true"></i> <?php echo esc_html__($item_bring_name, 'homey'); ?></dd>
                                    <?php  $count++;
                                endforeach;
                            } ?>
                        </dl>
