    ...
    if ( typeof Homey_Experience !== "undefined" ) {
        ...
        btnnext.on('click', function(e) {
            ...
            if (current < experFormStep.length) {
                // Check validation
                if ($(experFormStepGal).is(':visible')) {
            ...
            plup_uploader.bind('FileUploaded', function ( up, file, ajax_response ) {
                ...
                if ( response.success ) {
                    ...
                    var gallery_thumbnail = '<figure class="upload-gallery-thumb">' +
                        ...
                        '<a class="icon-featured" data-thumb="' + response.thumb + '" data-experience-id="' + 0 + '"  data-attachment-id="' + response.attachment_id + '"><i class="fa fa-star-o"></i></a>' +
                        '<button class="icon-delete" data-experience-id="' + 0 + '"  data-attachment-id="' + response.attachment_id + '"><i class="fa fa-trash-o"></i></button>' +
        ...
        $( '#add_more_what_will_bring' ).on('click', function( e ){
            ...
            var newOption = '' +
                ...
                '<textarea id="what_to_bring_name'+numVal+'" type="text" name="what_to_bring['+numVal+'][name]" class="form-control" placeholder="'+Homey_Experience.what_to_bring_name_plac+'"></textarea>'+
                '</div>'+
                '</div>'+
                '<!--<div class="col-sm-12 col-xs-12">'+
                '<div class="form-group">'+
                '<label for="what_to_bring_desc'+numVal+'"> '+Homey_Experience.what_to_bring_desc+' </label>'+
                '<textarea id="what_to_bring_desc'+numVal+'" type="text" name="what_to_bring['+numVal+'][desc]" class="form-control" placeholder="'+Homey_Experience.what_to_bring_desc_plac+'"></textarea>'+
                '</div>'+
                '</div>-->'+
                '</div>'+
                '<div class="row">'+
        ...
        $( '#add_more_what_will_provided' ).on('click', function( e ){
            ...
            var newOption = '' +
                ...
                '<input id="what_to_provided_name'+numVal+'" type="text" name="what_to_provided['+numVal+'][name]" class="form-control" placeholder="'+Homey_Experience.what_to_provided_name_plac+'">'+
                '</div>'+
                '</div>'+
                '<div class="col-sm-12 col-xs-12">'+
                '<div class="form-group">'+
                '<label for="what_to_provided_desc'+numVal+'"> '+Homey_Experience.what_to_provided_desc+' </label>'+
                '<textarea id="what_to_provided_desc'+numVal+'" type="text" name="what_to_provided['+numVal+'][desc]" class="form-control" placeholder="'+Homey_Experience.what_to_provided_desc_plac+'"></textarea>'+
                '</div>'+
                '</div>'+
                '</div>'+
                '<div class="row">'+
