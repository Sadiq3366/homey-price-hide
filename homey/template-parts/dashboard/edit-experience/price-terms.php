...
$smoke = homey_get_exp_field_meta('smoke');
$pets = homey_get_exp_field_meta('pets');
$party = homey_get_exp_field_meta('party');
$children = homey_get_exp_field_meta('children');
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="cancel"><?php echo esc_attr(homey_option('ad_cancel_policy')) . homey_req('experience_cancellation_policy'); ?></label>
                            <select name="cancellation_policy" class="selectpicker" data-live-search="false"
                                    data-live-search-style="begins"
                                    title="<?php echo esc_attr(homey_option('ad_cancel_policy')); ?>">
