    ...
    <div class="block">
        ...
        <div class="block-body">
            ...
            <div class="row">
                ...
                <?php if($hide_fields_for_experience['experience_address'] != 1) { ?>
                <div class="col-sm-8">
            ...
            <div class="row add-experience-map">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="map_canvas" data-add-lat="<?php echo esc_attr($add_location_lat); ?>" data-add-long="<?php echo esc_attr($add_location_long); ?>" id="experience_map">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row add-experience-map">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <span id="experience_find" class="btn btn-primary btn-full-width"><?php echo esc_attr(homey_option('experience_ad_find_address_btn')); ?></span>
                </div>
            </div>
        </div>
    </div>
