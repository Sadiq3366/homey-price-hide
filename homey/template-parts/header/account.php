...
//----add bulk listing by using CSV file
// $dashboard_add_bulk = 'http://localhost/myWeb/add-bulk-listing/';
$dashboard_add_bulk = get_site_url('', 'add-bulk-listing');
    ...
    <div class="account-dropdown">
        <ul>
            ...
            if (!homey_is_renter()) {
                ...
                //----add bulk listing by using CSV file
                if (!empty($dashboard_add_bulk)) {
                    echo '<li><a href="' . esc_url($dashboard_add_bulk) . '"><i class="fa fa-file-excel-o"></i>Add Bulk Listing </a></li>';
                }
            }
