                        ...
                        case 'location':
                            ...
                            <div class="<?php echo esc_attr($location_classes); ?>">
                                ...
                                elseif($location_field == 'country') { ?>
                                    ...
                                    <select id="sa_country_selectpicker_mobile" name="country" class="selectpicker" data-live-search="false">
                                    <?php
                                    // All Option
                                    ...
                                    <select data-pre-selected-cities-text="<?php echo $srh_whr_to_go; ?>" title="<?php echo $srh_whr_to_go; ?>" name="city" id="sa_city_selectpicker_mobile" class="selectpicker" data-live-search="false" multiple="true" data-all-option-is-selected="false">
                                        <?php
                                        // All Option
                                        echo '<option value="">' . $srh_whr_to_go . '</option>';
