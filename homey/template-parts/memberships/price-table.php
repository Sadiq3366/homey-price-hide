...
<div class="price-table-module">
    ...
    <div class="price-table-description">
        <ul class="list-unstyled">
            <li>
                <i class="fa fa-check" aria-hidden="true"></i> <?php esc_html_e('Time Period', 'homey'); ?>: <strong><?php echo esc_attr($billing_frequency).' '.esc_html__(esc_attr(ucfirst($billing_period)), 'homey'); ?></strong>
            </li>
            <li>
                <i class="fa fa-check" aria-hidden="true"></i> <?php echo esc_html__('Listings', 'homey'); ?>: <strong><?php echo esc_attr($unlimited_listings) == 'on' ? esc_html__('Unlimited Listings', 'homey') : esc_attr($listings_included); ?></strong>
            </li>
            <li>
