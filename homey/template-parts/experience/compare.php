...
<div id="compare-property-panel" class="compare-property-panel compare-property-panel-vertical compare-property-panel-right">
	...
	foreach($ids as $id ) { ?>
		<div class="compare-item remove-<?php echo intval($id); ?>">
			<a href="" class="remove-compare remove-icon" data-experience_id="<?php echo intval($id); ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
			<img class="img-responsive" src="<?php echo get_the_post_thumbnail_url($id, 'homey-experience-thumb'); ?>" width="450" height="300" alt="<?php esc_attr_e('Thumb', 'homey'); ?>">
		</div>
	<?php } 
	}?>
	</div>
