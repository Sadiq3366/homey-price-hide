 ...
 */ 
get_header();
global $post, $experience_founds, $paged;
...
<section class="main-content-area experience-page experience-page-full-width homey-matchHeight-needed">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div id="experiences_module_section" class="experience-wrap item-card-view">
