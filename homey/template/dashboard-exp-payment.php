                        ...
                        <form name="homey_checkout" method="post" class="homey_payment_form" action="<?php echo esc_url($stripe_processor_link); ?>">
                            <div class="dashboard-area">
                                ...
                                <div id="without_stripe" class="payment-buttons">
                                    ...
                                    <?php
                                    if($is_hourly == 'yes') { ?>
                                        <button id="make_exp_hourly_booking_payment" class="btn btn-success btn-full-width"><?php esc_html_e('Process Payment', 'homey'); ?></button>
                                    <?php    
                                    } else { ?>
                                        <button id="make_exp_booking_payment" class="btn btn-success btn-full-width"><?php esc_html_e('Process Payment', 'homey'); ?></button>
                                    <?php
                                    }
                                    ?>
