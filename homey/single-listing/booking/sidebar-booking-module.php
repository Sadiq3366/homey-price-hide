...
?>
					...
					<?php 
					if(!empty($instant_coupen))
					{
					
					?>
					<div class="less-coupen-deal">
						<input type="text" name="coupen" placeholder="enter coupen code"  class="form-control coupens-deals" id="coupens_deals">
						<button type="button" id="apply_coupon" name="apply_coupon" class="btn btn-primary"><?php echo esc_html__('APPLY', 'homey'); ?></button>
					</div>
					<?php }	?>
