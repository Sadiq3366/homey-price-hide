...
<div class="booking-sidebar">
    ...
    <div class="block">
        ...
        <div class="booking-property clearfix">
            ...
            <div class="booking-property-img">
                ...
                if( has_post_thumbnail( $experience_id ) ) {
                    echo get_the_post_thumbnail( $experience_id, 'homey-experience-thumb',  array('class' => 'img-responsive' ) );
                }else{
        ...
        <div class="block-body">
            ...
            <?php get_template_part('single-experience/booking/payment-list-collapse-hourly'); ?>
        </div><!-- block-body -->
    </div><!-- block -->
</div><!-- booking-sidebar -->