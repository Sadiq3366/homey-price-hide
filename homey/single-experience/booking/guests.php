...
<div class="search-guests exp-single-guests-js">
	...
	<div class="search-guests-wrap exp-single-form-guests-js clearfix">
		...
		<div class="adults-calculator">
			...
			<button class="exp_adult_plus btn btn-secondary-outlined" type="button"><i class="fa fa-plus" aria-hidden="true"></i></button>
			<button class="exp_adult_minus btn btn-secondary-outlined" type="button"><i class="fa fa-minus" aria-hidden="true"></i></button>
		</div>

		<?php if($booking_hide_fields['children'] != 1) { ?>
		<div class="children-calculator">
			<span class="quantity-calculator exp_homey_child">0</span>
			<span class="calculator-label"><?php echo esc_attr(homey_option('srh_child_label')); ?></span>
			<button class="exp_child_plus btn btn-secondary-outlined" type="button"><i class="fa fa-plus" aria-hidden="true"></i></button>
			<button class="exp_child_minus btn btn-secondary-outlined" type="button"><i class="fa fa-minus" aria-hidden="true"></i></button>
		</div>
		<?php } ?>
