			...
			<div class="sidebar-booking-module-body">
				<div class="homey_notification search-wrap search-banner">
					...
					<div id="single-experience-date-range" class="search-date-range">
						...
						<div id="single-booking-search-calendar" class="search-calendar hourly-js-mobile single-experience-booking-calendar-js clearfix" style="display: none;">
					...
					<?php get_template_part('single-experience/booking/guests-overlay-hourly'); ?>
...
<div class="overlay-booking-btn visible-sm visible-xs">
	<div class="pull-left">
		<div class="overlay-booking-price">
			<?php echo homey_formatted_price($experience_price, false, false); ?><span><?php echo esc_attr($price_separator); ?><?php echo homey_get_price_label();?></span>
		</div>
		<?php 
