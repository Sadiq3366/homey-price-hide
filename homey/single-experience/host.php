        ...
        <div class="block-head">
            <div class="media">
                ...
                <div class="media-body">
                    <h2 class="title"><?php echo esc_attr(homey_option('sn_hosted_by')); ?> <span><?php echo esc_attr($experience_author['name']); ?></span>
                    </h2>
                    ...
                    <ul class="list-inline profile-host-info">
                        ...
                        <li><address><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo esc_attr($experience_author['country']); ?></address></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
