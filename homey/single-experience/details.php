            ...
            <div class="block-body">
                ...
                <div class="block-right">
                    <ul class="detail-list detail-list-2-cols">
                        ...
                        <?php if(!empty($experience_rooms) && $hide_labels['sn_rooms_label'] != 1) { ?>
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i> 
                            <?php echo esc_attr(homey_option('sn_rooms_label')); ?>: <strong><?php echo esc_attr($experience_rooms); ?></strong>
                        </li>
                        <?php } ?>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i> 
                            <?php echo esc_attr(homey_option('sn_type_label')); ?>: <strong><?php echo esc_attr($room_type).' '.$slash.' '.esc_attr($experience_type); ?>  </strong>
                        </li>
                        <?php } ?>
