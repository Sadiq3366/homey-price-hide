    ...
    <div class="block">
        <div class="block-section block-section-50">
            <div class="block-body">
                ...
                <?php if($experience_type != '' || !empty($guests) || !empty($size)) { ?>
                    ...
                    <div class="block-left">
                        ...
                        <ul class="detail-list">
                            <?php if($hide_labels['sn_type_label'] != 1 && $experience_type != '') { ?>
                            <li><i class="fa fa-angle-right" aria-hidden="true"></i> <?php echo esc_attr(homey_option('sn_type_label')); ?>: <strong><?php echo esc_attr($experience_type); ?></strong></li>
                            <?php } ?>
