                            ...
                            switch($key) { 
                                ...
                                case 'prices':
                                    if( $homey_booking_type == 'per_hour') {
                                        get_template_part('single-experience/prices-hourly');
                                    } else {
                                ...
                                case 'availability':
                                    if( $homey_booking_type == 'per_hour') {
                                        get_template_part('single-experience/availability-hourly');
                                    } else {
                                ...
                                case 'similar-experience':
                                    if( $homey_booking_type == 'per_hour') {
                                        get_template_part('single-experience/similar-experience-hourly');
                                    } else {
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 homey_sticky">
                <div class="sidebar right-sidebar">
                    ...
                    if( homey_affiliate_booking_link() ) { ?>
                        ...
                        if( $homey_booking_type == 'per_hour') {
                            get_template_part('single-experience/booking/sidebar-booking-hourly');
                        } else {
