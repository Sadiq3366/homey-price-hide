...
$smoke            = homey_get_experience_data('smoke');
$pets             = homey_get_experience_data('pets');
$party            = homey_get_experience_data('party');
$children         = homey_get_experience_data('children');
